...
public abstract class SuperMeetingGenerator {
    ...
    public static List<Meeting> SUPER_MEETINGS = new ArrayList<>(Arrays.asList(
            ...
            new Meeting(4, LocalDate.of(2023, 6, 3), LocalTime.of(10, 0), Room.ROOM4, "Qui à mangé ma part de gateau ?!",  Arrays.asList("eli@lamzone.com", "ali@lamzone.com", "eddy@lamzone.com"))
    ));
